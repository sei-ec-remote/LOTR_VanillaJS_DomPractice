...
function makeBuddies() {
	...
	asideElement.setAttribute('id', 'asideTag')
	// put an `unordered list` of the `'buddies'` in the aside
	const buddiesList = document.createElement('ul')
	for (let i = 0; i < buddies.length; i++) {
	const buddiesListNames = document.createElement('li')
	buddiesListNames.setAttribute('id', buddies[i])
	buddiesListNames.innerText = buddies[i]
	buddiesListNames.setAttribute('class', 'buddy')
	buddiesList.appendChild(buddiesListNames)
	} console.log(buddiesList)

	asideElement.appendChild(buddiesList)
	const theRivendell = document.querySelector('#Rivendell')
	theRivendell.appendChild(asideElement)
...
function leaveTheShire() {
	...
	const hobbitsList = document.querySelector('#hobbitsList')
	const theRivendell = document.querySelector('#Rivendell')
	theRivendell.appendChild(hobbitsList)
	// const theRivendell = document.querySelector('#Rivendell')
	// theRivendell.appendChild(hobbitsList)
...
function beautifulStranger() {
	...
	const theStrider = document.querySelector('#Strider')
	theStrider.innerText = 'Aragorn'
}
...
function theBalrog() {
	...
	const gandalfSelect = document.querySelectorAll('.buddy')
	const gandalf = gandalfSelect[0]
	gandalf.innerText = 'Gandalf the White'
	gandalf.style.backgroundColor = 'white'
	gandalf.style.border = 'grey solid'
...
function hornOfGondor() {
	...
	const boromirSelect = document.querySelectorAll('.buddy')
	const boromir = boromirSelect[4]
	boromir.remove()
...
function weWantsIt() {
	...
	const ringRemove = document.querySelector('#the-ring')
	ringRemove.remove()
	const theRing = document.createElement('div')
	theRing.setAttribute('id', 'the-ring')
	theRing.setAttribute('class', 'magic-imbued-jewelry')
