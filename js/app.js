...
function makeHobbits() {
	...
	for(let i=0;i<hobbits.length;i++) {
		...
		theShire.appendChild(thisHobbit);
	}
...
function makeBaddies() {
	...
	for(let i=0;i<baddies.length;i++) {
		...
		createLi.setAttribute("class","baddy");
		createLi.setAttribute("id",baddies[i]);
		createLi.innerText = baddies[i];
...
function hornOfGondor() {
	...
	removeBoromir = document.getElementById("fellowship-Boromir");
...
function thereAndBackAgain() {
	...
	for(let i=0;i<hobbits.length;i++) {
		const thisHobbit = document.getElementById("fellowship-"+hobbits[i]);
		theShire.appendChild(thisHobbit);
	}
