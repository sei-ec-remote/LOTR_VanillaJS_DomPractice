...
function makeBuddies() {
	...
	document.getElementById("Rivendell").appendChild(ulBuddies)
}
...
function theBalrog() {
	...
	const gandalf = fellowshipArray[0]
...
function itsDangerousToGoAlone() {
	...
	console.log(fellowship)
	const fellowshipArray = fellowship.children
	Mordor.appendChild(fellowshipArray[4])
	Mordor.appendChild(fellowshipArray[4])
...
function weWantsIt() {
	...
	const oneRing = document.getElementById("the-ring")
