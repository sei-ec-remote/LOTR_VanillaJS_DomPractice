...
function makeMiddleEarth() {
	...
	//   2c. includes an h1 with the name of the land inside each land article
		...
		//textContent is for adding text to an html element
		//innerhtml will add html content
		//if i call a div and attach a p then i will use innerhtml however just adding text would be inner text
	//   2d. appends each land to the middle-earth section
	// we need to append the landname to landarticle and then append to middle earth
...
function thereAndBackAgain() {
	...
	const hobs = document.getElementById('hobbits')
	const theShire = document.querySelector('#The-Shire')

	theShire.appendChild(hobs)

	const mordor  = document.getElementById('baddies')
	const morArray = mordor.children
	const frodo = morArray[4]
	const sam = morArray[5]

	theShire.append(frodo)
	theShire.append(sam)
