...
function hornOfGondor() {
	...
	alert('Boromir has been killed by Uruk-hai! Why must Sean Bean always die?!')
	// Remove `Boromir` from the Fellowship
	const fellowship = document.getElementById('the-fellowship')
	document.getElementsByClassName('Boromir')[0].remove()
}
...
function itsDangerousToGoAlone() {
	...
	let frodo = document.getElementsByClassName('Frodo')[0]
	let sam = document.getElementsByClassName('Samwise "Sam" Gamgee')[0]
...
function thereAndBackAgain() {
	...
	theShire.append(...mountDoom.childNodes)
	theShire.append(document.getElementsByClassName(`Meriadoc "Merry" Brandybuck`)[0])
	theShire.append(document.getElementsByClassName(`Peregrin "Pippin" Took`)[0])
