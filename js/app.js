...
function theBalrog() {
	...
	document.getElementById(buddies[0]).style.background ="white"
	document.getElementById(buddies[0]).style.border ="thick solid grey"
...
function weWantsIt() {
	...
	const theRing = document.createElement('div')
		...
		document.getElementById('Frodo Baggins')
